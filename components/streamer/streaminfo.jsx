  ...
  return (
    <>
      <div className="flex p-3 w-full justify-between ">
        <div className="flex">
          <div className="flex rounded-full overflow-hidden mr-3 h-20 w-20 border-4 border-blue-500">
            <Image
        ...
        <div>
          <div className="flex justify-end">
            ...
            <Button color={`bg-gray-500`} sub={true}>
              Subscribe
            </Button>
          </div>
          <div className="flex items-center my-1">
            ...
            <ArrowUpIcon className="h-7 w-7 p-1 rounded-md m-1 hover:bg-slate-300/20" />
            <DotsVerticalIcon className="h-7 w-7 p-1 rounded-md m-1 hover:bg-slate-300/20" />
          </div>
        </div>
      </div>
    </>
