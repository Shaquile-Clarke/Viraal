  ...
  return (
    <div className="flex h-[300px] xl:block xl:fixed xl:w-[384px] xl:top-14 xl:right-0 xl:bottom-14 xl:h-screen text-white drop-shadow-lg bg-[#181818] xl:border-l xl:border-gray-400">
      ...
      <div className="flex w-full justify-center">
        ...
        <form
          action=""
          className="flex items-end xl:absolute xl:bottom-40 w-full xl:w-10/12 xl:justify-center text-black"
        >
          <div className="flex items-center w-full">
            <input
              type="text"
              placeholder="Send a message"
              className="h-10 pl-3 w-screen xl:full rounded bg-slate-700 py-6 placeholder:text-gray-slate-500"
            />
            <Button
              color={`bg-blue-700`}
            ...
            <EmojiHappyIcon className="hidden xl:block xl:absolute w-6 text-black right-2 pointer-events-none" />
          </div>
        </form>
      </div>
    </div>
